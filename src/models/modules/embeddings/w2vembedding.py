...
class W2VEmbedding(nn.Module):
    def __init__(self, emb_conf, fields) -> None:
        ...
        self.word_emb = nn.Embedding(n_feats['words'], emb_conf.word_emb)
        
        n_input = emb_conf.word_emb
    ...
    def forward(self, x_table) -> torch.Tensor:
        ...
        word_embs = self.word_emb(x_table['words'])
        ...
        embs = torch.cat([word_embs, feat_embs], dim = -1)
